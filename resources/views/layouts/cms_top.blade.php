...
<div class="topbar">
    ...
    <div class="topbar-left">
        <a href="{{route('dashboard')}}" class="logo">
            <span>
                <img src="{{ URL::asset('assets/cms/images/logo_sorocabacom.png')}}" alt="" height="30">
            </span>
            <i>
                 <img src="{{ URL::asset('assets/cms/images/logo_sorocabacom_sm.png')}}" alt="" height="30">
            </i>
        </a>
    </div>
            ...
            <li class="d-none d-sm-block">
                <div class="dropdown pt-3 d-inline-block">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink"> 
                        @if($auth->role->id == 1) <a class="dropdown-item" href="{{route('usuarios.create')}}">Usuário</a> @endif
                    </div>
                </div>
            </li>
        </ul>
